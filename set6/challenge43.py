...
def challenge43():
    ...
    for k in range(0, 2**16 + 1):
        x = dsa_recover_x_int(k, 0xd2d0714f014a9784047eaeccf956520045c45265, r, s)
        priv = int_to_bytes(x)
        if hashlib.sha1(binascii.hexlify(priv)).hexdigest() == '0954edd5e0afe5542a4adf012611a91912a3ec16':
            return x
